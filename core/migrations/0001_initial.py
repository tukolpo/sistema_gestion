    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(help_text='Ej: Administrador, Supervisor, Oficial', max_length=50, unique=True)),
                ('nivel_jerarquia', models.IntegerField(help_text='Ej: 100 para Admin, 50 para Supervisor, 10 para Básico', unique=True)),
